...
class SnakePlayer(list):
    ...
    def sense_food_ahead(self):
        if self.direction == S_UP:
            # Food will be ahead if the columns are the same and the index of the food's row is less
            return self.food[0][1] == self.body[0][1] and self.food[0][0] < self.body[0][0]
        elif self.direction == S_DOWN:
            # Food will be ahead if the columns are the same and the index of the food's row is greater
            return self.food[0][1] == self.body[0][1] and self.food[0][0] > self.body[0][0]
        elif self.direction == S_LEFT:
            # Food will be ahead if the rows are the same and the index of the food's column is less
    ...
    def sense_food_left(self):
        if self.direction == S_UP:
            # Food will be ahead if the columns are the same and the index of the food's row is less
            return self.food[0][1] == self.body[0][1] and self.food[0][1] < self.body[0][1]
        elif self.direction == S_DOWN:
            # Food will be ahead if the columns are the same and the index of the food's row is greater
            return self.food[0][1] == self.body[0][1] and self.food[0][1] > self.body[0][1]
        elif self.direction == S_LEFT:
...
def main():
    ...
    with open('one_range.txt', 'w') as f:
